...
if (!__Pyx_RefNanny) {
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "features")) {
      if (unlikely(PyDict_SetItemString(modules, "features", __pyx_m) < 0)) __PYX_ERR(0, 2, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_available, __pyx_t_1) < 0) __PYX_ERR(0, 2, __pyx_L1_error)
